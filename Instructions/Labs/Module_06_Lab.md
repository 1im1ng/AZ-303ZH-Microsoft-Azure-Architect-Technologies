---
lab:
    title: '6: 实现和配置 Azure 存储文件和 Blob 服务'
    module: '模块 6：实现存储帐户'
---
...
1. 在 **“az30306a-vm0”** 边栏选项卡上，选择 **“连接”**，在下拉菜单中选择 **“RDP”**，然后选择 **“下载 RDP 文件”**。
...
1. 在 **“az30306a-vm0”** 的远程桌面会话中，启动 Internet Explorer 并导航到 [“Azure 存储资源管理器”](https://azure.microsoft.com/zh-cn/features/storage-explorer/)的下载页面。
...
1. 在 **“az30306a-vm0”** 的远程桌面会话中，启动 Internet Explorer，导航到 [“Azure 门户”](https://portal.azure.com)，然后通过提供要在本实验室中使用的订阅中具有所有者角色的用户帐户凭据来登录。
...
1. 在 **“使用 SAS URI 附加”** 窗口中的 **“显示名称”** 文本框中，键入 **“az30306a-blobs”**， 在 **“URI”** 文本框中，将复制的值粘贴到剪贴板，然后选择 **“下一步”**。 
...
1. 右键选择 **“az30306a-blobs”** 条目，在右键菜单中选择 **“创建 Blob 容器”**，然后使用空白文本框将容器名称设置为 **“container1”**。
...
1. 在与 **“az30306a-vm0”** 的远程桌面会话中，在浏览器窗口的存储帐户边栏选项卡的 **“Blob 服务”** 部分，选择 **“容器”**。
...
1. 在 **az30306a-vm0** 远程桌面会话中，在浏览器窗口，导航至 [“开始使用 AzCopy”](https://docs.microsoft.com/zh-cn/azure/storage/common/storage-use-azcopy-v10)。
...
1. 在 **az30306a-vm0** 远程桌面会话中，在显示 Azure 门户的浏览器窗口，导航回到你在本实验室的第一个练习中创建的“存储帐户边栏选项卡”，然后在 **“文件服务”** 部分，选择 **“文件共享”**。
...
1. 在 **“az30306a-vm0”** 的远程桌面会话中，在 PowerShell 提示符后粘贴并执行你复制的脚本。
...
1. 在用户帐户列表中，选择代表 **“az30306auser1”** 用户帐户的条目，选择工具栏中的省略号图标，选择 **“删除用户”**，并在提示确认时选择 **“是”**。  
