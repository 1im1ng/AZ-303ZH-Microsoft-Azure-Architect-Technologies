...
1. 在 Azure 存储资源管理器窗口中，在 **“连接到 Azure 存储”** 窗口的 **“选择资源”** 选项卡上，选择 **“存储帐户”**。

1. 在 Azure 存储资源管理器窗口中，在 **“连接到 Azure 存储”** 窗口的 **“选择身份验证方法”** 选项卡上，选择 **“共享访问签名(SAS)”**。

1. 在 Azure 存储资源管理器窗口中，在 **“连接到 Azure 存储”** 窗口的 **“输入连接信息”** 选项卡上，在 **“显示名称”** 框中键入 **“az30306a-blobs”**，在 **“SAS 连接字符串或服务 URL”** 文本框中粘贴你复制到剪贴板的值，然后选择 **“下一步”**。 
...
1. 在 Cloud Shell 窗格中运行以下命令，创建一个文件并向其中添加一行文本：
   ...
   Set-Content './az30306ablob.html' 'Hello from az30306ablob via SAS<h3></h3>'
   ```
